...
export function DepositIcon({ height = "256", width = "256", className = "icons-svg", strokeWidth = "10", stroke = "white", fill = "white" }: any) {
  return (
    <svg
      id="deposit-icon"
    ...
    >
      <g>
        <path d="M14,6a1,1,0,0,0,0-2H8A1,1,0,0,0,8,6Z" fill={fill}
          stroke={stroke}
