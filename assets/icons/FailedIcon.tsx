...
export function FailedIcon({ height = "256", width = "256", className = "" }: any) {
    return (
        <svg
            ...
            <g>
                <g>
                    <path style={{ fill: "#25AE88" }} d="M16.779,23.888H6.215c-1.079,0-1.968-0.844-1.968-1.923V4.446c0-1.079,0.889-1.928,1.968-1.928h13.677
               ...
               L7.498,18.164L7.498,18.164z"/>
                    <path style={{ fill: "#ff0000" }} d="M26.065,24.332l1.483-1.646l1.728-1.914c0.813-0.904,0.744-2.301-0.161-3.115c-0.908-0.816-2.3-0.743-3.117,0.16
