...
export function PowerButtonIcon({ height = "512", width = "512", className = "icons-svg" }: any) {
    return (
        <svg
            ...
            className={className}
        >
            <path fill="#CEE8FA" d="M274.338,169.874h-36.677c-15.267,0-27.644-12.377-27.644-27.644V43.017
	...
	C301.982,157.499,289.605,169.874,274.338,169.874z"/>
            <g>
                <path  stroke={"#ffffff"} fill="#ffffff;" d="M274.338,185.247h-36.675c-23.72,0-43.017-19.298-43.017-43.017V43.017
		...
		H237.663z"/>
                <path fill="#ffffff;" d="M256,439.89c-95.108,0-172.484-77.377-172.484-172.483c0-18.558,3.002-36.926,8.922-54.588
		...
		C428.484,362.514,351.108,439.89,256,439.89z"/>
                <path fill="#ffffff;" d="M256,512C121.132,512,11.407,402.276,11.407,267.408c0-81.618,40.346-157.465,107.926-202.89
