...
export function SearchIcon({ height = "512", width = "512", className = "icons-svg", fill = "", strokeWidth = "10" }: any) {
    return (
        <svg
            id="search-icon"
