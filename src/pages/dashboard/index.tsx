...
export default function Dashboard() {
    ...
    const [tileItems, setTileItems] = useState({
        savings: {
            icon: <SavingsIcon fill={theme.extend.colors.primary["900"]} />,
            value: "",
            title: "Savings",
            addable: {
        ...
        earnings: {
            icon: <BasketIcon fill={theme.extend.colors.primary["900"]} />,
            value: "N5, 000",
            title: "Earnings",
            viewable: {
        ...
        investments: {
            icon: <PortfolioIcon fill={theme.extend.colors.primary["900"]} />,
            value: "N5, 000",
            title: "Investments",
            addable: {
                icon: <PlusIcon className="p-1 bg-green-900 rounded-lg h-5 w-5" height="60" width="60" />,
