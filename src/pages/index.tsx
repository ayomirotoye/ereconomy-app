        ...
        <PageWrapper isHeaderVisible={true}>
            <div className="md:grid grid-cols-2 gap-4 mx-14 my-10">
                <div className="flex flex-col justify-center items-left">
                    ...
                    <p className="mt-5 md:mt-3 text-left md:text-lg sm:text-sm">{(IntroContent.text)}</p>
                </div>
            ...
            <div className="md:grid grid-cols-2 gap-4 mx-14 my-[128px]">
                ...
                <div>
                    ...
                    <Button className="text-left w-full md:w-1/3 py-2 font-bold bg-green-900 text-white rounded-lg border-0 cursor-pointer my-3"><span className="flex justify-start p-3"><PowerButtonIcon /> Start Now</span></Button>
                </div>
            </div>
        </PageWrapper >
    )
